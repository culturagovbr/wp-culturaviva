...
if ( ! function_exists( 'rede_cultura_viva_setup' ) ) :
/**
 ...
 */
function rede_cultura_viva_setup() {
	/*
...
endif; // rede_cultura_viva_setup
add_action( 'after_setup_theme', 'rede_cultura_viva_setup' );
 ...
 */
function rede_cultura_viva_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'rede_cultura_viva_content_width', 640 );
}
add_action( 'after_setup_theme', 'rede_cultura_viva_content_width', 0 );
 ...
 */
function rede_cultura_viva_widgets_init() {
...
add_action( 'widgets_init', 'rede_cultura_viva_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function rede_cultura_viva_scripts() {
...
add_action( 'wp_enqueue_scripts', 'rede_cultura_viva_scripts' );
